...
class EvaluatorFlagDetail(BaseModel):
    """Detailed information about an evaluator flag."""
    flag: str = Field(..., description="Flag name (e.g., 'unverified_feature')")
    details: Optional[Dict[str, Any]] = Field(None, description="Additional details about the flag")
...
class ResponseMetadata(BaseModel):
    ...
    evaluator_details: Optional[List[EvaluatorFlagDetail]] = Field(None, description="Detailed flag information")
